...
<div class="usa-accordion">
  <ul class="usa-unstyled-list">
    ...
    <li>
      <button class="usa-button-unstyled"
        aria-expanded="true" aria-controls="collapsible-0">
        4.2 <strong>Provide opportunities to develop and innovate together. </strong>
      </button>
      <div id="collapsible-0" aria-hidden="false" class="usa-accordion-content">
    ...
    <li>
      <button class="usa-button-unstyled"
        aria-expanded="true" aria-controls="collapsible-0">
        4.4 <strong>Make it easy for anyone to participate. </strong>
      </button>
      <div id="collapsible-0" aria-hidden="false" class="usa-accordion-content">
        <p>We make it easy for staff who don’t usually work on social media<em>—</em>archivists or archives technicians, for instance<em>—</em>to share the stories of the fascinating documents they encounter while working or share their otherwise fascinating roles at NARA.</p>
